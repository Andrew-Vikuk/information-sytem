...
ReactDOM.render(
  ...
  document.getElementById('root')
                            ...
                            <ul>
                              ...
                              <h4>Чому не варто використовувати індекси як ключі?</h4>
    <p>
        Коли елементи списку додаються, видаляються або змінюють порядок, React може неправильно співставляти компоненти, якщо використовуються індекси як ключі. Це може призвести до таких проблем:
    </p>
    <ul>
        <li>Некоректне оновлення стану: Компоненти можуть зберігати стан, який більше не відповідає даним.</li>
        <li>Зниження продуктивності: React може виконувати зайві операції з оновлення DOM, що знижує продуктивність.</li>
        <li>Неправильний рендеринг: Компоненти можуть рендеритися неправильно, коли елементи змінюють своє місце в списку.</li>
    </ul>
